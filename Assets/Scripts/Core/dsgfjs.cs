...
namespace Core
{
    public class dsgfjs : dfghsjsdf
    {
        ...
        public struct ahgas12334
        {
            public int asa;

            public ahgas12334(int ___)
            {
                asa = 1235;
            }
        ...
        public void SetFieldVisibility(bool isVisible)
        {
            ...
            var aa = adsfhsa.Get<adsfhdjsfgmasdfh>();
            var asd = new ahgas12334();
        }
